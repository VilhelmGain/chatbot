...
function applySecurityHeaders(response: NextResponse, nonce: string): void {
  ...
  const csp = [
    ...
    "img-src 'self' data: blob: https://img.clerk.com https://*.clerk.com https://*.clerk.accounts.dev https://*.googleusercontent.com https://*.githubusercontent.com https://*.gravatar.com https:",
    "font-src 'self' data:",
