...
export const InlineDocumentSkeleton = () => (
  <div className="flex w-full flex-col gap-3">
    <div className="h-3.5 w-48 animate-pulse rounded bg-white/5-foreground/10" />
    <div className="h-3.5 w-3/4 animate-pulse rounded bg-white/5-foreground/8" />
    <div className="h-3.5 w-1/2 animate-pulse rounded bg-white/5-foreground/8" />
    <div className="h-3.5 w-64 animate-pulse rounded bg-white/5-foreground/8" />
    <div className="h-3.5 w-40 animate-pulse rounded bg-white/5-foreground/8" />
  </div>
);
